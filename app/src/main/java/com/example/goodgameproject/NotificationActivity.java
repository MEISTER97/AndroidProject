...
import com.example.goodgameproject.utilities.NotificationAdapter;
                    ...
                    for (Map<String, Object> friendData : friendDataList) {
                        ...
                        if (friendId != null) {
                            fetchFriendDetails(friendId, account -> {
                                if (account != null) {
                                    notificationItems.add(new NotificationItem(account.getProfileName(), R.drawable.profilegamer1, friendId));
                                }
